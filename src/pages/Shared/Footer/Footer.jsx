...
const Footer = () => {
  return (
    <footer className="bg-background  text-white mt-20 relative font-sans overflow-hidden border-t border-gray-900">
      {/* (Decorative Blur) */}
      ...
      <div className="max-w-6xl mx-auto px-6 pt-16 pb-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 relative z-10 text-center sm:text-left">
        ...
        <div className="flex flex-col items-center sm:items-start space-y-4">
          ...
          <div className="flex items-center gap-3 group cursor-pointer w-max">
            {/* card S icon */}
            <div className="relative w-11 h-11 flex items-center justify-center rounded-xl bg-secondary shadow-[0_4px_15px_rgba(0,0,0,0.4)] overflow-hidden group-hover:border-blue-500/50 transition-all duration-500">
              {/* Bg color */}
          ...
          <div className="flex gap-3.5 pt-2 justify-center sm:justify-start">
            <a
              href="#"
              className="w-9 h-9 flex items-center justify-center rounded-xl bg-secondary text-gray-400 hover:text-white hover:bg-blue-600 hover:shadow-[0_0_15px_rgba(37,99,235,0.5)] transition-all duration-300"
            >
            ...
            <a
              href="#"
              className="w-9 h-9 flex items-center justify-center rounded-xl bg-secondary text-gray-400 hover:text-white hover:bg-sky-500 hover:shadow-[0_0_15px_rgba(14,165,233,0.5)] transition-all duration-300"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="#"
              className="w-9 h-9 flex items-center justify-center rounded-xl bg-secondary text-gray-400 hover:text-white hover:bg-emerald-500 hover:shadow-[0_0_15px_rgba(16,185,129,0.5)] transition-all duration-300"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
